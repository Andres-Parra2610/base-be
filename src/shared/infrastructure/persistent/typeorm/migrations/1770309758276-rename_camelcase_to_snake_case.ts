...
export class RenameCamelcaseToSnakeCase1770309758276 implements MigrationInterface {
    name = 'RenameCamelcaseToSnakeCase1770309758276'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_roles" ADD "deletedAt" TIMESTAMP`);
